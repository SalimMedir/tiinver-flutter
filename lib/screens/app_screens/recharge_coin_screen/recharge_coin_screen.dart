...
class RechargeCoinScreen extends StatelessWidget {
  RechargeCoinScreen({super.key});
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Center(
                child: TextWidget1(text: "Recharge Coins", fontSize: 24.dp, fontWeight: FontWeight.w700,
