...
class HomeMediaScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: PageView.builder(
        ...
        itemCount: dashboardProvider.timeLine.length,
        scrollDirection: Axis.vertical,
        itemBuilder: (context, index) {
          final activity = dashboardProvider.timeLine[index];
            ...
            children: [
              Center(
                child: activity.isImage()
                    ...
                    : activity.isVideo()
                        ? HomeVideoPlayerScreen(activity: activity)
                        : Container(
                            height: 100.h,
                            width: 100.w,
                        ...
                        onTap: () {
                          dashboardProvider
                            ...
                            userApiKey: signInProvider.userApiKey.toString(),
                              ...
                              .whenComplete(() {
                            dashboardProvider.fetchTimeline(
                              int.parse(signInProvider.userId!),
                              100,
                              0,
...
class HomeVideoPlayerScreen extends StatelessWidget {
  ...
  const HomeVideoPlayerScreen({super.key, required this.activity});
