...
class OtherProfileMediaScreen extends StatelessWidget {

  final Activity activity;
  final int otherUserId;
  // final List<Activity> activities;

  OtherProfileMediaScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: PageView.builder(
        ...
        itemCount: otherProfileProvider.media.length,
        scrollDirection: Axis.vertical,
        itemBuilder: (context, index) {

          final activity = otherProfileProvider.media[index];
            ...
            children: [
              Center(
                child: activity.isImage()
                    ...
                    : activity.isVideo()
                    ? OtherProfileVideoPlayerScreen(activity: activity)
                    : Container(
                  height: 100.h,
                  width: 100.w,
...
class OtherProfileVideoPlayerScreen extends StatelessWidget {
  final Activity activity;

  const OtherProfileVideoPlayerScreen({super.key, required this.activity});
